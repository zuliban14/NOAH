...
reducers: {
    ...
    export const { onLimpiarPregunta, addEventPregunta, deletePregunta, actualizarTipoPregunta, actualizarPregunta, onListarPregunta, activaEvent } = preguntaSlice.actions;